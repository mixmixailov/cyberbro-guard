...
from .utils.admin import is_admin_request
    ...
    try:
        ...
        response_data = {
            ...
            "wal": {
                ...
                "checkpoint_needed": (
                    wal_info.get("wal_pages", 0) > 1000 or 
                    wal_info.get("wal_size_bytes", 0) > 64 * 1024 * 1024
                )
            },
            "dlq": {
            ...
            "recent_unreplayed": [
                {
                    ...
                    "error_preview": item.error[:100] + "..." if len(item.error) > 100 else item.error
                }
