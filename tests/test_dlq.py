...
from app.services.dlq import DLQItem, DLQService, add_failed_job_to_dlq, add_failed_update_to_dlq
...
class TestDLQService:
    ...
    def test_add_to_dlq_basic(self):
        ...
        with (
            patch("app.services.dlq.execute_immediate") as mock_execute,
            ...
            dlq_id = DLQService.add_to_dlq(
                job_id="test_job_123", job_type="update", payload=payload, error=error, attempts=3
            )
    ...
    def test_mark_replayed_success(self):
        ...
        with (
            patch("app.services.dlq.DLQService.get_dlq_item", return_value=mock_item),
    ...
    def test_mark_replayed_already_replayed(self):
        ...
        with (
            patch("app.services.dlq.DLQService.get_dlq_item") as mock_get,
    ...
    def test_cleanup_old_replayed(self):
        ...
        with (
            patch("app.services.dlq.execute_immediate", return_value=3),
    ...
    def test_update_size_gauge(self):
        ...
        with (
            patch("app.services.dlq.fetchone", return_value=mock_count),
...
class TestDLQHelperFunctions:
    ...
    def test_add_failed_update_to_dlq(self):
        ...
        update_data = {"update_id": 123, "message": {"chat": {"id": 456}, "from": {"id": 789}}}
    ...
    def test_add_failed_job_to_dlq(self):
        ...
        with (
            patch("app.services.dlq.DLQService.add_to_dlq", return_value=99) as mock_add,
...
class TestDLQIntegration:
    ...
    def test_metrics_integration(self):
        ...
        with (
            ...
            DLQService.add_to_dlq(
                job_id="metrics_test", job_type="test", payload={}, error="Test error", attempts=1
            )
