...
from app.db.session import checkpoint_wal, get_wal_info
...
class TestWALInfo:
    ...
    def test_get_wal_info_basic(self):
        ...
        with (
            patch("app.db.session._get_conn") as mock_conn_func,
    ...
    def test_checkpoint_wal_modes(self):
        ...
        for mode in modes:
            with (
                patch("app.db.session._get_conn") as mock_conn_func,
                patch(
                    "app.db.session.get_wal_info",
                    return_value={"wal_pages": 0, "wal_size_bytes": 0},
                ),
            ):
                mock_conn = MagicMock()
                mock_conn.__enter__ = MagicMock(return_value=mock_conn)
...
class TestMaintenanceService:
    ...
    async def test_update_wal_metrics(self):
        ...
        with (
            patch("app.services.maintenance.get_settings"),
    ...
    async def test_check_and_checkpoint_needed_pages(self):
        ...
        mock_checkpoint_result = {"success": True, "duration_ms": 25.0}
    ...
    async def test_check_and_checkpoint_needed_size(self):
        ...
        with (
            ...
            mock_to_thread.side_effect = [mock_wal_info, {"success": True, "duration_ms": 30.0}]
    ...
    async def test_force_checkpoint(self):
        ...
        mock_result = {"success": True, "mode": "FULL", "duration_ms": 40.0}
    ...
    async def test_get_maintenance_status(self):
        ...
        mock_wal_info = {"wal_pages": 200, "wal_size_bytes": 5 * 1024 * 1024}
...
class TestMaintenanceIntegration:
    ...
    async def test_maintenance_loop_single_iteration(self):
        ...
        mock_wal_info = {"wal_pages": 100, "wal_size_bytes": 1024 * 1024}
